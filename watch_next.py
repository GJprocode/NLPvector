...
print(i + "-" + str(similarity)) # similarity sentence least similarity with -0.7483523503220888
...
print(movie_title[l1.index(max(l1))]) #Printing the movie title

# movie A is given in the vector similarity
